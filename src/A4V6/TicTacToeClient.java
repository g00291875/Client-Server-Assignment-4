...
public class TicTacToeClient extends JApplet  implements Runnable{
   ...
   public void run()
   {
      ...
      try {
         ...
         boolean check = true;
         while ( check == true ) { //while connection is true
...
//            processMessage( input.readUTF() );//constantly reading processmessage, is it a valid move?
   ...
   private void processMessage( String message ) {
       switch (message) {
           case "Valid move.": // tells player who just moved
           ...
           case "Invalid move, try again":
               ...
               myTurn = true;
               break;
           case "Opponent moved": // tells player who received the move
                   updateMove();
           ...
           case "game over":
                updateMove();
                displayMessage("you lose, do you want to play again?.\n");
                break;
//          case "win":
//              //  updateMove();
//                displayMessage("you win, do you want to play again?.\n");
//               break;
//           case "draw":
//                //   updateMove();
//                   displayMessage("it's a draw, do you want to play again?.\n");
//              break;
           default:
               displayMessage(message + "\n");
               updateMove();
...
//               else if
   ...
   public void sendClickedSquare( int location )
   {
      if ( myTurn ) {
         ...
         try {
            output.writeInt( location );  /** INT   TO   THE    SERVER**/
