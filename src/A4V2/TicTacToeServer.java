...
public class TicTacToeServer extends JFrame {
   ...
   /*********************************88
    *  server constructor -> inner class contructor x2 for players
    *  execute runs ( wait for each client to connect)
    *
    *
    *
    * **********************************
   ...
   public TicTacToeServer()
   {
      ...
      board = new char[ 9 ]; 
      players = new Player[ 2 ];// call inner private class constructor "player" to make 2 player objects
      currentPlayer = PLAYER_X; // current player = 0
 
      // set up ServerSocket
      try {
         server = new ServerSocket( 12348, 2 );
      }
   ...
   public void execute()
   {
      ...
      // Resume player X now.          
      synchronized ( players[ PLAYER_X ] ) {//this synchronised block for player x
   ...
   public static void main( String args[] )
   {
      ...
      application.execute();// wait for players to connect
   }
