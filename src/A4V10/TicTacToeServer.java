...
//         }
          ...
          && board [4] != '\0' && board [5] != '\0' && board [6] != '\0' && board [7] != '\0' && board [7] != '\0') {
            whoIsWinner = "draw";
            return true;
         }
      return false;
         ...
         try {/*************************************************************START RUN ***/
            ...
            while (! isGameOver() ) {          /***** MAIN LOOP MAIN LOOP MAIN LOOP MAIN LOOP MAIN LOOP **/
               try{
                  ...
                  else if (validateAndMove(location, playerNumber) && !isGameOver()) {
                     output.writeUTF(whoIsWinner);
                     output.writeInt(location);
                  }
//                  else if (isGameOver())
